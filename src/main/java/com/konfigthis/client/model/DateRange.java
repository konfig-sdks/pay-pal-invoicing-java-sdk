 ...
 */
@ApiModel(description = "The date range. Filters invoices by creation date, invoice date, due date, and payment date.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DateRange {
  ...
  public DateRange start(String start) {
    ...
    if (start != null && start.length() < 10) {
      throw new IllegalArgumentException("Invalid value for start. Length must be greater than or equal to 10.");
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The stand-alone date, in [Internet date and time format](https://tools.ietf.org/html/rfc3339#section-5.6). To represent special legal values, such as a date of birth, you should use dates with no associated time or time-zone data. Whenever possible, use the standard `date_time` type. This regular expression does not validate all dates. For example, February 31 is valid and nothing is known about leap years.")
  ...
  public DateRange end(String end) {
    ...
    if (end != null && end.length() < 10) {
      throw new IllegalArgumentException("Invalid value for end. Length must be greater than or equal to 10.");
    }
  ...
  **/
   ...
   * @return the DateRange instance itself
   */
  public DateRange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, dateRange.start) &&
        ...
        Objects.equals(this.additionalProperties, dateRange.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DateRange>() {
           ...
           public DateRange read(JsonReader in) throws IOException {
             ...
             DateRange instance = thisAdapter.fromJsonTree(jsonObj);
