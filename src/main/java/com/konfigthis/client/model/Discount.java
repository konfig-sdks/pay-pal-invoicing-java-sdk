 ...
 */
@ApiModel(description = "The discount as a percent or amount at invoice level. The invoice discount amount is subtracted from the item total.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Discount {
  ...
  **/
  ...
  @ApiModelProperty(value = "The percentage, as a fixed-point, signed decimal number. For example, define a 19.99% interest rate as `19.99`.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(percent, amount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Discount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
