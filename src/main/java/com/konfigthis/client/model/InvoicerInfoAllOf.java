...
public class InvoicerInfoAllOf {
  ...
  public InvoicerInfoAllOf() {
  }

  public InvoicerInfoAllOf emailAddress(String emailAddress) {
  ...
  **/
  ...
  public InvoicerInfoAllOf phones(List<PhoneDetail> phones) {
  ...
  public InvoicerInfoAllOf addPhonesItem(PhoneDetail phonesItem) {
    if (this.phones == null) {
  ...
  **/
  ...
  public InvoicerInfoAllOf website(URI website) {
  ...
  **/
  ...
  public InvoicerInfoAllOf taxId(String taxId) {
  ...
  **/
  ...
  public InvoicerInfoAllOf additionalNotes(String additionalNotes) {
  ...
  **/
  ...
  public InvoicerInfoAllOf logoUrl(URI logoUrl) {
  ...
  **/
   ...
   * @return the InvoicerInfoAllOf instance itself
   */
  public InvoicerInfoAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoicerInfoAllOf invoicerInfoAllOf = (InvoicerInfoAllOf) o;
    return Objects.equals(this.emailAddress, invoicerInfoAllOf.emailAddress) &&
        Objects.equals(this.phones, invoicerInfoAllOf.phones) &&
        Objects.equals(this.website, invoicerInfoAllOf.website) &&
        Objects.equals(this.taxId, invoicerInfoAllOf.taxId) &&
        Objects.equals(this.additionalNotes, invoicerInfoAllOf.additionalNotes) &&
        Objects.equals(this.logoUrl, invoicerInfoAllOf.logoUrl)&&
        Objects.equals(this.additionalProperties, invoicerInfoAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, phones, website, taxId, additionalNotes, logoUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvoicerInfoAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicerInfoAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicerInfoAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicerInfoAllOf is not found in the empty JSON string", InvoicerInfoAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicerInfoAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicerInfoAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicerInfoAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicerInfoAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicerInfoAllOf>() {
           @Override
           public void write(JsonWriter out, InvoicerInfoAllOf value) throws IOException {
           ...
           @Override
           public InvoicerInfoAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicerInfoAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicerInfoAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicerInfoAllOf
  * @throws IOException if the JSON string is invalid with respect to InvoicerInfoAllOf
  */
  public static InvoicerInfoAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicerInfoAllOf.class);
  }

 /**
  * Convert an instance of InvoicerInfoAllOf to an JSON string
  *
  * @return JSON string
  */
