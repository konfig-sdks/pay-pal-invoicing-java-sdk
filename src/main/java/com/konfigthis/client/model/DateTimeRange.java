 ...
 */
@ApiModel(description = "The date and time range. Filters invoices by creation date, invoice date, due date, and payment date.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DateTimeRange {
  ...
  public DateTimeRange start(String start) {
    ...
    if (start != null && start.length() < 20) {
      throw new IllegalArgumentException("Invalid value for start. Length must be greater than or equal to 20.");
    }
  ...
  **/
  ...
  public DateTimeRange end(String end) {
    ...
    if (end != null && end.length() < 20) {
      throw new IllegalArgumentException("Invalid value for end. Length must be greater than or equal to 20.");
    }
  ...
  **/
   ...
   * @return the DateTimeRange instance itself
   */
  public DateTimeRange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, dateTimeRange.start) &&
        ...
        Objects.equals(this.additionalProperties, dateTimeRange.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DateTimeRange
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DateTimeRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DateTimeRange>() {
           ...
           public DateTimeRange read(JsonReader in) throws IOException {
             ...
             DateTimeRange instance = thisAdapter.fromJsonTree(jsonObj);
