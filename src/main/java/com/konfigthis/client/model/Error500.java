 ...
 */
@ApiModel(description = "This is either a system or application error, and generally indicates that although the client appeared to provide a correct request, something unexpected has gone wrong on the server.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error500 {
  ...
  **/
  ...
  @ApiModelProperty(example = "INTERNAL_SERVER_ERROR", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AN_INTERNAL_SERVER_ERROR_OCCURRED_", value = "")
  ...
  **/
  ...
  public Error500 links(List<ErrorLinkDescription> links) {
  ...
  public Error500 addLinksItem(ErrorLinkDescription linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the Error500 instance itself
   */
  public Error500 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, error500.name) &&
        ...
        Objects.equals(this.links, error500.links)&&
        Objects.equals(this.additionalProperties, error500.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Error500
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Error500.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Error500>() {
           ...
           public Error500 read(JsonReader in) throws IOException {
             ...
             Error500 instance = thisAdapter.fromJsonTree(jsonObj);
