 ...
 */
@ApiModel(description = "The billing information of the invoice recipient. Includes name, address, email, phone, and language.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BillingInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(businessName, name, address, emailAddress, phones, additionalInfo, language, additionalProperties);
  }
