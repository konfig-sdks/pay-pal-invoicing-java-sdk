 ...
 */
@ApiModel(description = "The tax information. Includes the tax name and tax rate of invoice items. The tax amount is added to the item total.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Tax {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the tax applied on the invoice items.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The percentage, as a fixed-point, signed decimal number. For example, define a 19.99% interest rate as `19.99`.")
  ...
  **/
   ...
   * @return the Tax instance itself
   */
  public Tax putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, percent, amount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Tax.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Tax>() {
           ...
           public Tax read(JsonReader in) throws IOException {
             ...
             Tax instance = thisAdapter.fromJsonTree(jsonObj);
