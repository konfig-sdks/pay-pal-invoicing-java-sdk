 ...
 */
@ApiModel(description = "The phone number, in its canonical international [E.164 numbering plan format](https://www.itu.int/rec/T-REC-E.164/en).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Phone {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countryCode, nationalNumber, extensionNumber, additionalProperties);
  }
