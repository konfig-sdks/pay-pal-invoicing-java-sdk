...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api-m.sandbox.paypal.com";
    private String tokenUrl = "/v1/oauth2/token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("Oauth2", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-m.sandbox.paypal.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /v1/oauth2/token)
     * @return An instance of OkHttpClient
     */
